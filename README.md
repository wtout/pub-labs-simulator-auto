...
To create the system inventory without deploying the system, issue the following command from the automation root directory (pub-labs-simulator-auto):
...
From the automation root directory (pub-labs-simulator-auto), run one of the bash scripts under the Bash directory depending on what you want to do. 
